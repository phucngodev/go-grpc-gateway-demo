...
const (
	UserService_Login_FullMethodName    = "/api.blog.v1.UserService/Login"
	UserService_Register_FullMethodName = "/api.blog.v1.UserService/Register"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.blog.v1.UserService",
